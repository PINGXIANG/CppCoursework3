...
{
    double mean = CalculateMean(SpotValues);
...
double PathDependentArithmeticAsian::CalculateMean(const std::valarray<double>& SpotValues) const
{
...
double PathDependentGeometricAsian::CalculateMean(const std::valarray<double>& SpotValues) const
{
